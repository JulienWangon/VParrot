...
/*CREATION EQUIPMENT TYPES TABLE*/
...
/*CREATION EQUIPMENTS TABLE*/
CREATE TABLE IF NOT EXISTS equipments
(
  id_equipment INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  denomination VARCHAR(50) NOT NULL,
  type_id INT NOT NULL,
  FOREIGN KEY (type_id) REFERENCES equipment_types(id_type)
);
